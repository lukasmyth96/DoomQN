    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            if len(labels) > 1:
                enemy = labels[0]
                player = labels[1]
                if np.abs(player.x - enemy.x) < (enemy.width / 4):
                    action = actions[2]  # shoot
                elif (player.x - enemy.x) > 0:
                    action = actions[0]  # left
                else:
                    action = actions[1]  # right
            else:
                action = choice(actions)  # enemy must be dead
            ...
            print("State #{}".format(str(n)))
            print("Game variables: {}".format(vars))
        ...
        print("Total reward:{}".format(game.get_total_reward()))
        print("************************")
